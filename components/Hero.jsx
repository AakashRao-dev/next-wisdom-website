...
export default function Hero() {
  return (
    <section className="bg-white">
      <div className="bg-white flex flex-col md:flex-row justify-between items-center w-[90%] min-h-[90vh] mx-auto py-20 md:pt-0">
        <div className="flex flex-col items-center md:items-start text-center md:text-left basis-3/4">
          ...
          <div className="w-[80%] flex justify-center md:justify-start flex-col xs:flex-row items-stretch xs:items-center gap-6">
            <a
              href="#get-in-touch"
