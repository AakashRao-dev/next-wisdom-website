...
export default function GetInTouch() {
  return (
    <section
      className="bg-white w-[90%] mx-auto flex sm:flex-row flex-col justify-between items-center sm:gap-12 xs:gap-6 gap-0 py-8 px-8 text-center sm:text-left"
      id="get-in-touch"
    >
      <div className="flex flex-col gap-9">
        ...
        >
          ...
          <span className="underline text-lg font-medium">+91 8839842061</span>
        </a>
      </div>
